...
# !!! Main.UserApp is configured as an alias for Main.Pogoda and you might encounter it in some tests
using Main.Pogoda, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Pogoda tests" begin
  @includetests ARGS
end
